...
@Component({
  selector: 'app-teacher-principal',
  templateUrl: './teacher-principal.page.html',
  styleUrls: ['./teacher-principal.page.scss'],
})
export class TeacherPrincipalPage implements OnInit {
  correo: string = "";
  weatherData: any;
  weatherIcon: string = "";
  ...
  constructor(
    ...
    private Teacher: TeachersApiService
  ) {}
